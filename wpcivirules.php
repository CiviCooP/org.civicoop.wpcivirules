 ...
 */
function wpcivirules_civicrm_xmlMenu(&$files) {
  _wpcivirules_civix_civicrm_xmlMenu($files);
}
 ...
 */
function wpcivirules_civicrm_managed(&$entities) {
  _wpcivirules_civix_civicrm_managed($entities);
}
 ...
 */
function wpcivirules_civicrm_caseTypes(&$caseTypes) {
  _wpcivirules_civix_civicrm_caseTypes($caseTypes);
}
 ...
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_caseTypes
 */
function wpcivirules_civicrm_angularModules(&$angularModules) {
_wpcivirules_civix_civicrm_angularModules($angularModules);
}
